...
// SQL query to fetch all projects with the latest status
$sql = "SELECT project_table.*, 
        ...
        ORDER BY project_table.id DESC";

$stmt = $conn->prepare($sql);

// If user_id exists, bind it to the query (optional filtering by user)
if (!empty($user_id)) {
...
// Fetch the results and populate the $projects array
