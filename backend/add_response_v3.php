...
if (isset($data->comment_id) && isset($data->response_text) && isset($data->responded_by)) {
    ...
    file_put_contents('php://stderr', "Sanitized Data: comment_id=$comment_id, response_text=$response_text, responded_by=$responded_by\n");

    // Prepare the SQL query to insert the response
    $sql = "INSERT INTO responses (comment_id, response_text, responded_by, response_date)
            VALUES ('$comment_id', '$response_text', '$responded_by', '$response_date')";
